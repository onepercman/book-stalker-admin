import { Button, ButtonVariantProps } from "@/libs/one-ui/components"
import { SelectSlotsClasses, select } from "@/libs/one-ui/theme"
...
export const Select = _constructor(function (
  ...
  return (
    ...
    >
      ...
      <Ark.Presence
        className="text-error text-xs animate-in fade-in"
